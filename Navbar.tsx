    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <a 
          ...
          aria-label="RĀW Superfood Café Home"
        >
        ...
        <div className="hidden md:flex items-center space-x-10">
          ...
          <button 
            className={`flex items-center gap-2 px-8 py-3 rounded-full transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 ${
              scrolled 
