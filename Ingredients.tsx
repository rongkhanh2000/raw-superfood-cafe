            ...
            <div className="space-y-8">
                <div className="flex items-start gap-6">
                    <div className="w-16 h-16 shrink-0 rounded-full overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1620916297397-a4a5402a3c6c?auto=format&fit=crop&q=80&w=200" alt="Chia Seeds" className="w-full h-full object-cover" loading="lazy" />
                    </div>
                    <div>
                 ...
                 <div className="flex items-start gap-6">
                    <div className="w-16 h-16 shrink-0 rounded-full overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1582793988951-9aed5509eb97?auto=format&fit=crop&q=80&w=200" alt="Matcha" className="w-full h-full object-cover" loading="lazy" />
                    </div>
                    <div>
                 ...
                 <div className="flex items-start gap-6">
                    <div className="w-16 h-16 shrink-0 rounded-full overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1549466872-69019d659a8c?auto=format&fit=crop&q=80&w=200" alt="Raw Cacao" className="w-full h-full object-cover" loading="lazy" />
                    </div>
                    <div>
