        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4 pt-2">
              <a href="#" className="hover:text-sand-500 transition-colors" aria-label="Instagram"><Instagram size={20} /></a>
              <a href="#" className="hover:text-sand-500 transition-colors" aria-label="Facebook"><Facebook size={20} /></a>
            </div>
          </div>
          ...
          <div>
             ...
             <form className="flex flex-col gap-3" onSubmit={(e) => e.preventDefault()}>
                ...
                />
                <button type="submit" className="bg-sand-500 text-earth-900 font-bold text-sm py-3 px-4 rounded-lg hover:bg-sand-100 transition-colors">
                    Subscribe
                </button>
             </form>
          </div>
